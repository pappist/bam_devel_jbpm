...
import org.jbpm.process.audit.BamEventListener;
import org.jbpm.process.audit.BamEngine;
...
public class CommandDelegate {
    ...
    private StatefulKnowledgeSession getSession() {
        if (ksession == null) {
            ...
            ksession.addEventListener(new BamEventListener());
            System.out.println("===== New StatefulKnowledgeSession created! =====");
	    BamEngine.initBamConnection();
        }
        return ksession;
    }
